...
Cache keys include the operating system, architecture, Python version, Chefe version, manifests,
and the solved lock. This prevents a matrix entry or tool upgrade from restoring an incompatible
environment.
