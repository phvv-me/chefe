...
La tabla `[deps]` simple es **conda**, la fuente por defecto. Una cadena simple es una especificación de versión, y `*` significa cualquiera.
...
Añada dependencias condicionalmente por plataforma, y estas se compilan a objetivos nativos de pixi. Cualquier ámbito se anida bajo `[on.…]`.
